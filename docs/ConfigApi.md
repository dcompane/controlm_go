...
[**ExportRole**](ConfigApi.md#ExportRole) | **Get** /config/authorization/role/{role}/export | Export Authorization Role
...
[**ImportRole**](ConfigApi.md#ImportRole) | **Post** /config/authorization/role/import | Import Authorization Role
...
# **ExportRole**
> RoleDataFull ExportRole(ctx, role)
Export Authorization Role
...
# **ImportRole**
> SuccessData ImportRole(ctx, roleFile)
