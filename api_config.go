...
*/
func (a *ConfigApiService) AddHostToHostgroup(ctx context.Context, body AgentInGroupParams, server string, hostgroup string) (AgentsInGroupSuccessData, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
ConfigApiService Export Authorization Role
Export Authorization Role
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param role The Role name.
@return RoleDataFull
*/
func (a *ConfigApiService) ExportRole(ctx context.Context, role string) (RoleDataFull, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue RoleDataFull
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/config/authorization/role/{role}/export"
	localVarPath = strings.Replace(localVarPath, "{"+"role"+"}", fmt.Sprintf("%v", role), -1)
...
/*
ConfigApiService Import Authorization Role
Import Authorization Role
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param roleFile
@return SuccessData
*/
func (a *ConfigApiService) ImportRole(ctx context.Context, roleFile *os.File) (SuccessData, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/config/authorization/role/import"
...
@return SuccessData
*/
func (a *ConfigApiService) UpdateHostsInHostgroup(ctx context.Context, body AgentInGroupParamsList, server string, hostgroup string) (SuccessData, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
